...
ORDER BY
   ...
   SELECT
    ...
    {{ channel_price('rr.source', 'rr.product_price', 'amazon', 'amazon_price') }},
    {{ channel_price('rr.source', 'rr.product_price', 'flipkart', 'flipkart_price') }},
    {{ channel_price('rr.source', 'rr.product_price', 'myntra', 'myntra_price') }},
    {{ channel_price('rr.source', 'rr.product_price', 'ajio', 'ajio_price') }}
