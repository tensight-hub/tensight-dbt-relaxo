...
select  date, "sale order number","invoice number","channel entry","channel ledger","product name","product sku code",qty,"unit price",currency,"conversion rate",total,"customer name","shipping address name","shipping address line 1","shipping address line 2","shipping address city","shipping address state","shipping address country","shipping address pincode","shipping address phone","shipping provider","awb num",sales,"sales ledger","other charges","other charges ledger","other charges1","other charges ledger1","service tax","st ledger","discount ledger","discount amount",imei,godown,"dispatch date/cancellation date",narration,entity,"voucher type name ","tin no","original invoice date ","original invoice no","invoice channel created","channel state","channel_party gstin","customer gstin","billing party code","tax verification","gst registration type","rp code",irn,"acknowledgement number","product hsn code","return type","extracted_date", 'Bangalore' as facility from {{ source('unicommerce', 'returns_uniware_bangalore') }}


UNION ALL 

select  date, "sale order number","invoice number","channel entry","channel ledger","product name","product sku code",qty,"unit price",currency,"conversion rate",total,"customer name","shipping address name","shipping address line 1","shipping address line 2","shipping address city","shipping address state","shipping address country","shipping address pincode","shipping address phone","shipping provider","awb num",sales,"sales ledger","other charges","other charges ledger","other charges1","other charges ledger1","service tax","st ledger","discount ledger","discount amount",imei,godown,"dispatch date/cancellation date",narration,entity,"voucher type name ","tin no","original invoice date ","original invoice no","invoice channel created","channel state","channel_party gstin","customer gstin","billing party code","tax verification","gst registration type","rp code",irn,"acknowledgement number","product hsn code","return type","extracted_date", 'Bhiwandi' as facility from {{ source('unicommerce', 'returns_uniware_bhiwandi') }}

    
UNION ALL

select  date, "sale order number","invoice number","channel entry","channel ledger","product name","product sku code",qty,"unit price",currency,"conversion rate",total,"customer name","shipping address name","shipping address line 1","shipping address line 2","shipping address city","shipping address state","shipping address country","shipping address pincode","shipping address phone","shipping provider","awb num",sales,"sales ledger","other charges","other charges ledger","other charges1","other charges ledger1","service tax","st ledger","discount ledger","discount amount",imei,godown,"dispatch date/cancellation date",narration,entity,"voucher type name ","tin no","original invoice date ","original invoice no","invoice channel created","channel state","channel_party gstin","customer gstin","billing party code","tax verification","gst registration type","rp code",irn,"acknowledgement number","product hsn code","return type","extracted_date", 'Ghevra' as facility from {{ source('unicommerce', 'returns_uniware_ghevra') }}


UNION ALL

select  date, "sale order number","invoice number","channel entry","channel ledger","product name","product sku code",qty,"unit price",currency,"conversion rate",total,"customer name","shipping address name","shipping address line 1","shipping address line 2","shipping address city","shipping address state","shipping address country","shipping address pincode","shipping address phone","shipping provider","awb num",sales,"sales ledger","other charges","other charges ledger","other charges1","other charges ledger1","service tax","st ledger","discount ledger","discount amount",imei,godown,"dispatch date/cancellation date",narration,entity,"voucher type name ","tin no","original invoice date ","original invoice no","invoice channel created","channel state","channel_party gstin","customer gstin","billing party code","tax verification","gst registration type","rp code",irn,"acknowledgement number","product hsn code","return type","extracted_date", 'Gurugram' as facility from {{ source('unicommerce', 'returns_uniware_gurugram') }}


UNION ALL

select  date, "sale order number","invoice number","channel entry","channel ledger","product name","product sku code",qty,"unit price",currency,"conversion rate",total,"customer name","shipping address name","shipping address line 1","shipping address line 2","shipping address city","shipping address state","shipping address country","shipping address pincode","shipping address phone","shipping provider","awb num",sales,"sales ledger","other charges","other charges ledger","other charges1","other charges ledger1","service tax","st ledger","discount ledger","discount amount",imei,godown,"dispatch date/cancellation date",narration,entity,"voucher type name ","tin no","original invoice date ","original invoice no","invoice channel created","channel state","channel_party gstin","customer gstin","billing party code","tax verification","gst registration type","rp code",irn,"acknowledgement number","product hsn code","return type","extracted_date", 'Hyderabad' as facility from {{ source('unicommerce', 'returns_uniware_hyderabad') }}


UNION ALL

select  date, "sale order number","invoice number","channel entry","channel ledger","product name","product sku code",qty,"unit price",currency,"conversion rate",total,"customer name","shipping address name","shipping address line 1","shipping address line 2","shipping address city","shipping address state","shipping address country","shipping address pincode","shipping address phone","shipping provider","awb num",sales,"sales ledger","other charges","other charges ledger","other charges1","other charges ledger1","service tax","st ledger","discount ledger","discount amount",imei,godown,"dispatch date/cancellation date",narration,entity,"voucher type name ","tin no","original invoice date ","original invoice no","invoice channel created","channel state","channel_party gstin","customer gstin","billing party code","tax verification","gst registration type","rp code",irn,"acknowledgement number","product hsn code","return type","extracted_date", 'Kolkata' as facility from {{ source('unicommerce', 'returns_uniware_kolkata') }}



UNION ALL

select  date, "sale order number","invoice number","channel entry","channel ledger","product name","product sku code",qty,"unit price",currency,"conversion rate",total,"customer name","shipping address name","shipping address line 1","shipping address line 2","shipping address city","shipping address state","shipping address country","shipping address pincode","shipping address phone","shipping provider","awb num",sales,"sales ledger","other charges","other charges ledger","other charges1","other charges ledger1","service tax","st ledger","discount ledger","discount amount",imei,godown,"dispatch date/cancellation date",narration,entity,"voucher type name ","tin no","original invoice date ","original invoice no","invoice channel created","channel state","channel_party gstin","customer gstin","billing party code","tax verification","gst registration type","rp code",irn,"acknowledgement number","product hsn code","return type","extracted_date",'Mundkha' as facility from {{ source('unicommerce', 'returns_uniware_mundkha_new') }}
